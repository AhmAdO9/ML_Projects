...
class DataIngestionConfig:
    train_data_path:str=os.path.join('artifacts/train', 'train.csv')
    test_data_path:str=os.path.join('artifacts/test', 'test.csv')
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            raise CustomException("Some Error Occurred in Data Ingestion", sys) from e
        pass
